import { getRandomPiece } from "@/constants/games/block-blast/Piece";
...
import { PieceView } from "@/components/games/block-blast/PieceView";

// Menu-decoration particle only — intentionally on the do-not-seed list,
// keeps using Math.random() so it never consumes seeded RNG state.
